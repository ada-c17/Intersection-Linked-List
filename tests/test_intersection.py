...
# Add test for listB longer than listA:


def test_will_return_intersection_with_lists_of_differing_lengths_second_list_longer():
    # Arrange
    node_d = Node("D")
    node_e = Node("E")
    node_f = Node("F")
    ...
    # Act
    answer = intersection_node(head_b, head_a)
